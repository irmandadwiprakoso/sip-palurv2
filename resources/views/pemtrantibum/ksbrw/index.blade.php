    ...
    <div class="wrapper">
            ...
            <!-- Filter Data --> 
                <div class="card card-danger">
                    <div class="card-header">
                        <h3 class="card-title">Filter Data KSB RW</h3>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label for="filter-ksbrwkel" class="form-label">KSBRW Kelurahan</label>
                                        <select class="form-control filter" id="filter-ksbrwkel" name="filter-ksbrwkel">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="filter-rwksbrw" class="form-label">RW Kelurahan</label>
                                            <select class="form-control filter" id="filter-rwksbrw" name="filter-rwksbrw">
                                                <option value="">-- Pilih RW --</option>
                                                @foreach ($rw as $rwksbrw)
                                                    <option value="{{ $rwksbrw->id }}">{{ $rwksbrw->rw }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
        ...
        @endif
            ...
            <!-- Main content / Tampilan Data -->
                            <div class="card card-danger">
                                <div class="card-header">
                                    <h3 class="card-title">Data KSBRW</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="dataksbrw" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th scope="col">#</th>
...
<!--------------Modal Create KSBRW------------------------->
<form action="/ksbrw" method="post" enctype="multipart/form-data">
    @csrf
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Add Data KSB RW</h4>
                        ...
                        <div class="card-body">
                            <form>
                                <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="no_sk" class="form-label">Nomor SK KSBRW</label>
...
<!--------------Modal View KSB RW------------------------->
    <div class="modal fade" id="modal-view">
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Detail Data KSBRW </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
