    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                ...
                @elseif(auth()->user()->role == "permasbang" || auth()->user()->role == "struktural" )
                <div class="col-lg-3 col-xs-6">
                  <div class="small-box bg-danger">
                    <div class="inner">
                      <p> Posyandu </p>
                      <h3> {{ $namaposyandu->where('village_id', '=', auth()->user()->village_id)->where('tipekesehatan_id', '=', '5')->count() }}</h3>
                    </div>
                    <div class="icon">
                        <i class="fas fa-solid fa-stethoscope"></i>
                      </div>
                ...
                <div class="col-lg-3 col-xs-6">
                  <div class="small-box bg-danger">
                    <div class="inner">
                      <p> Posyandu </p>
                      <h3> {{ $namaposyandu->where('village_id', '=', auth()->user()->village_id)->where('rw_id', '=', auth()->user()->rw_id)->where('tipekesehatan_id', '=', '5')->count() }}</h3>
                    </div>
                    <div class="icon">
                        <i class="fas fa-solid fa-stethoscope"></i>
                      </div>
                                ...
                                <div class="row">
                                    @if (auth()->user()->role == "superadmin")             
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control filter" id="filter-namaposyandukel" name="filter-namaposyandukel">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control filter" id="filter-rwnamaposyandu" name="filter-rwnamaposyandu">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-danger">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="datanamaposyandu" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th scope="col">#</th>
                                                <th scope="col">Nama</th>
                                                <th scope="col">Tipe Posyandu</th>
...
<form action="/namaposyandu" method="post" enctype="multipart/form-data">
    @csrf
                        ...
                        <div class="card-body">
                            <form>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                                ...
                                                <input type="text" onkeyup="this.value = this.value.toUpperCase()"
                                                    ...
                                                    id="nama" placeholder="Nama Posyandu" name="nama"
                                                    value="{{ old('nama') }}">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                                <label for="nama_pimpinan">Nama Pimpinan Posyandu</label>
                                                <input type="text" onkeyup="this.value = this.value.toUpperCase()"
                                                    class="form-control @error('nama_pimpinan') is-invalid @enderror"
                                                    id="nama_pimpinan" placeholder="Nama Pimpinan Posyandu" name="nama_pimpinan"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                                <label for="keterangan">Jumlah Bayi Posyandu</label>
                                                <input type="number" onkeyup="this.value = this.value.toUpperCase()"
                                                    class="form-control @error('keterangan') is-invalid @enderror"
                                                    id="keterangan" placeholder="Jumlah Bayi Posyandu" name="keterangan"
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                        <div class="form-group">
                                                <label for="tipekesehatan_id">Tipe Posyandu</label>
                                                <select class="form-control @error('tipekesehatan_id') is-invalid @enderror"
                                                    ...
                                                    <option selected disabled>- Pilih Tipe Posyandu-</option>
                                    ...
                                    <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="foto" value="{{ old('foto') }}">Foto Posyandu</label>
